...
public:
    ...
    //==========================================================================
    // Activates an already-fully-loaded parser + sample cache (built off the
    // audio thread). This is a cheap pointer swap — safe to call from the
    // audio thread immediately after allNotesOff().
    //==========================================================================
    void setActivePreset (SLRParser* parser, SampleCache* cache, int presetIndex) noexcept
    {
...
private:
    ...
    SampleCache*        sampleCache_       = nullptr;
